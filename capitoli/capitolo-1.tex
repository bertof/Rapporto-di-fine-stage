...
L'azienda fa uso di un gran numero di tecnologie durante le proprie attività; di seguito analizzerò le più utilizzate.
   ...
   \begin{figure}[H]
      \begin{center}
         \includegraphics[width=14cm,height=6.5cm,keepaspectratio]{immagini/java-architecture}      
      \end{center}
   ...
   \begin{figure}[H]
      ...
      \end{center}
      \caption{Architettura di Android. Source: \href{https://developer.android.com/guide/platform/index.html}{Documentazione Android Developers}}
   \end{figure}
   ...
   \end{figure}
   %TODO: G Suite include bla bla bla questo fa qusto, questo fa quello
   ...
   \begin{figure}[H]
      \begin{center}
         ...
         \caption{Architettura di una pagina Wordpress e gerarchia delle pagine. Source: \href{https://developer.wordpress.org/themes/basics/template-hierarchy/}{Wordpress Developer Documentation}}
      \end{center}
   \end{figure}
