...
\section{Come lavora}
   ...
   Per ogni \engl{sprint} il team pianifica quali \engl{task} dovranno essere svolti e a chi andrà assegnato ciascuno di essi, definendo così il \engl{backlog} dello sprint.
   \\
   ...
   \paragraph{NapkinForever --- Paperworld 2017}
   \begin{figure}[H]
      \begin{center}
...
%TODO: chiedere come migliorare la sezione
