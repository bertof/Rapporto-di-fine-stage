...
\section{Come lavora}
   ...
   \engl{Scrum} definisce uno sprint come l'unità di misura dello sviluppo di un progetto, un periodo di tempo di lunghezza fissata generalmente tra una settimana e quattro settimane.
   Le attività necessarie per l'avanzamento del progetto sono organizzate nel \engl{backlog} del prodotto.
   Per ogni sprint il team pianifica quali task dovranno essere svolti e a chi andrà assegnato ciascuno di essi, definiendo così il \engl{backlog} dello sprint.
   \\
   Ogni giorno il team si ritrova con una breve riunione, detta ``\engl{daily scrum}'', per controllare lo stato dei task e degli obiettivi. I meeting giornalieri permettono al project manager di avere misure dello stato del progetto con più frequenza, rispetto ad altri modelli di sviluppo, così da intervenire più rapidamente alla necessità di correzioni.
   \\
