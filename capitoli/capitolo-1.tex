...
\begin{figure}[H]
   \begin{center}
      \includegraphics[height=1.5cm,keepaspectratio]{immagini/vla-logo}
   \end{center}
...
I prodotti principali di \nomeAzienda{} sono software personalizzati, siti web e contenuti video. L'azienda costruisce il brand del cliente, pone le fondamenta della sua rete di clienti e si occupa di consulenze e di \gls{SEO}. Con il crescere del team e l'acquisizione di nuovo personale, \nomeAzienda{} sta espandendo i propri servizi sempre più verso servizi cloud per le aziende e software per dispositivi \gls{wearable} e \gls{IoT} più specializzati, come nel caso del progetto VisionHealthCare.
...
L'azienda fa uso di un gran numero di tecnologie durante le proprie attività; di seguito analizzerò le più utilizzate.
   ...
   \begin{figure}[H]
      \begin{center}
         \includegraphics[width=6cm,height=1.5cm,keepaspectratio]{immagini/rackspace-logo}
      \end{center}
   ...
   \begin{figure}[H]
      \begin{center}
         \includegraphics[width=6cm,height=1.5cm,keepaspectratio]{immagini/firebase-logo}
      \end{center}
   ...
   \begin{figure}[H]
      \begin{center}
         \includegraphics[width=6cm,height=2.5cm,keepaspectratio]{immagini/java-logo}      
      \end{center}
