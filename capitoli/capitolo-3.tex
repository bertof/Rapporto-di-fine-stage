...
Una volta definiti i casi d'uso, ho proceduto alla scelta dei protocolli di rete da utilizzare e la progettazione strutturale del sistema.
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[height=20cm,keepaspectratio]{UML/png/Design Model__SimpleClasses_6}
			\caption{Diagramma delle classi del sistema}\label{diagrammaclassi}
		\end{center}
	\end{figure}

		\subsubsection{Concrete model interfacce del modello}
		Il modello è responsabile del salvataggio e della gestione delle infomazioni legate agli utenti, ai canali, alle registrazioni e 
