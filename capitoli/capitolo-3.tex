...
%%\section{Tecnologie utilizzate}
     %\subsection$2{Linguaggi --- Java}
      %Integrazione facile con Android

     %\subsection$2{Piattaforma --- Tomcat8 EE}

     %\subsection$2{Protocollo --- TCP su WebSocket}

     %\subsection$2{Tipo di dati scambiati --- JSON vs XML}
      %Meno prolisso
      %Scelto per semplificare la codifica della piattaforma
      %Facile a comprendere
     %\subsection$2{Strumetni di supporto}
           %\subsubsection$2{Strumenti di versionamento}
         %Git e Bitbucket
           %\subsubsection$2{Strumenti di test e verifica}
         %JUnit
           %\subsubsection$2{Strumenti di analisi di rete}
         %Wireshark
           %\subsubsection$2{Strumenti di continuous integration}
         %Docker
\section{Nuovi orizzonti}
     %\subsection$2{Blockchain}
     %\subsection$2{Streaming peer to peer}

\section{Qualifica}
     %\subsection$2{Verifica}
           %\subsubsection$2{Analisi statica}
           %\subsubsection$2{Analisi dinamica}
     %\subsection$2{Validazione}
           %\subsubsection$2{Validazione interna}
           %\subsubsection$2{Validazione esterna}